...
@app.route('/')
def home():
    return "🤖 M7S TELE BOT HOSTING🦁 is Running!"
@app.route('/health')
def health():
...
# --- Configuration ---
TOKEN = '8362742726:AAGziYfiqVNBiGzufRP-vEKqEfzqkwJVD-U'
OWNER_ID = 6893661111
ADMIN_ID = 6893661111
YOUR_USERNAME = '@M7S_7M'
UPDATE_CHANNEL = 'https://t.me/M7S_TECH_LAB'
# Folder setup
...
def create_system_stats_message():
    ...
    msg = f"""
╔══════════════════════════════════════╗
║       📊 <b>♛❖ 𝑴7𝑺 𝑻𝑬𝑳𝑬 𝑩𝑶𝑻 𝑯𝑶𝑺𝑻𝑰𝑵𝑮❖ ♛  𝐒𝐓𝐀𝐓𝐒</b> 📊         ║
╠══════════════════════════════════════╣
...
def run_script(script_path, script_owner_id, user_folder, file_name, message_obj, attempt=1):
    ...
    try:
        ...
        terminal_msg = f"""
╔══════════════════════════════════════╗
║      🚀 <b>♛❖ 𝑴7𝑺 𝑻𝑬𝑳𝑬 𝑩𝑶𝑻 𝑯𝑶𝑺𝑻𝑰𝑵𝑮❖ ♛: STARTING SCRIPT</b> 🚀 ║
╠══════════════════════════════════════╣
...
"""
        ...
        if process.poll() is None:
            success_msg = f"""
╔══════════════════════════════════════╗
║     ✅ <b>♛❖ 𝑴7𝑺 𝑻𝑬𝑳𝑬 𝑩𝑶𝑻 𝑯𝑶𝑺𝑻𝑰𝑵𝑮❖ ♛: SCRIPT RUNNING</b> ✅   ║
╠══════════════════════════════════════╣
...
"""
            ...
            error_msg = f"""
╔══════════════════════════════════════╗
║     ❌ <b>♛❖ 𝑴7𝑺 𝑻𝑬𝑳𝑬 𝑩𝑶𝑻 𝑯𝑶𝑺𝑻𝑰𝑵𝑮❖ ♛: SCRIPT FAILED</b> ❌     ║
╠══════════════════════════════════════╣
║ 📄 <b>File:</b> <code>{file_name[:25]}</code>
...
def run_js_script(script_path, script_owner_id, user_folder, file_name, message_obj, attempt=1):
    ...
    try:
        ...
        terminal_msg = f"""
╔══════════════════════════════════════╗
║      🟢 <b>♛❖ 𝑴7𝑺 𝑻𝑬𝑳𝑬 𝑩𝑶𝑻 𝑯𝑶𝑺𝑻𝑰𝑵𝑮❖ ♛: STARTING NODE.JS</b> 🟢║
╠══════════════════════════════════════╣
║ 📄 File: <code>{file_name[:25]}</code>
║ 👤 User: {script_owner_id}
║ 🔄 Attempt: {attempt}/{max_attempts}
...
"""
        ...
        if process.poll() is None:
            success_msg = f"""
╔══════════════════════════════════════╗
║     ✅ <b>♛❖ 𝑴7𝑺 𝑻𝑬𝑳𝑬 𝑩𝑶𝑻 𝑯𝑶𝑺𝑻𝑰𝑵𝑮❖ ♛: NODE.JS RUNNING</b> ✅  ║
╠══════════════════════════════════════╣
║ 📄 <b>File:</b> <code>{file_name[:25]}</code>
║ 🆔 <b>PID:</b> {process.pid}
║ ⏱️ <b>Started:</b> {datetime.now().strftime('%H:%M:%S')}
...
"""
            ...
            error_msg = f"""
╔══════════════════════════════════════╗
║     ❌ <b>♛❖ 𝑴7𝑺 𝑻𝑬𝑳𝑬 𝑩𝑶𝑻 𝑯𝑶𝑺𝑻𝑰𝑵𝑮❖ ♛: NODE.JS FAILED</b> ❌    ║
╠══════════════════════════════════════╣
║ 📄 <b>File:</b> <code>{file_name[:25]}</code>
║ ❗ <b>Exit Code:</b> {process.returncode}
╠══════════════════════════════════════╣
...
def stats_command(message):
    ...
    user_id = message.from_user.id
    msg = send_spinner_animation(message.chat.id, "𝐆𝐚𝐭𝐡𝐞𝐫𝐢𝐧𝐠 𝑴7𝑺 𝑻𝑬𝑳𝑬 𝑩𝑶𝑻 𝐬𝐭𝐚𝐭𝐬...", duration=2)
...
def speed_command(message):
    ...
    msg = send_spinner_animation(message.chat.id, "𝐓𝐞𝐬𝐭𝐢𝐧𝐠 𝑴7𝑺 𝑻𝑬𝑳𝑬 𝑩𝑶𝑻 𝐬𝐩𝐞𝐞𝐝...", duration=2)
    ...
    speed_text = f"""
╔══════════════════════════════════════╗
║        ⚡ <b>♛❖ 𝑴7𝑺 𝑻𝑬𝑳𝑬 𝑩𝑶𝑻 𝑯𝑶𝑺𝑻𝑰𝑵𝑮❖ ♛ 𝐒𝐏𝐄𝐄𝐃</b> ⚡        ║
╠══════════════════════════════════════╣
║
...
def running_command(message):
    """Show running bots"""
    user_id = message.from_user.id
    msg = send_spinner_animation(message.chat.id, "𝐅𝐞𝐭𝐜𝐡𝐢𝐧𝐠 𝑴7𝑺 𝑻𝑬𝑳𝑬 𝑩𝑶𝑻 𝐛𝐨𝐭𝐬...", duration=1)
    running_bots = []
...
def lock_command(message):
    ...
    lock_text = f"""
╔══════════════════════════════════════╗
║         🔐 <b>♛❖ 𝑴7𝑺 𝑻𝑬𝑳𝑬 𝑩𝑶𝑻 𝑯𝑶𝑺𝑻𝑰𝑵𝑮❖ ♛ 𝐒𝐓𝐀𝐓𝐔𝐒</b> 🔐       ║
╠══════════════════════════════════════╣
║
║  𝐒𝐭𝐚𝐭𝐮𝐬: {status}
...
def process_broadcast(message):
    ...
    if not broadcast_text:
        ...
        return
    progress_msg = bot.send_message(message.chat.id, "📢 𝐒𝐭𝐚𝐫𝐭𝐢𝐧𝐠 𝑴7𝑺 𝑻𝑬𝑳𝑬 𝑩𝑶𝑻 𝐛𝐫𝐨𝐚𝐝𝐜𝐚𝐬𝐭...")
    success = 0
    failed = 0
    ...
    for i, user_id in enumerate(active_users):
        try:
            formatted_msg = f"""
╔══════════════════════════════════════╗
║      📢 <b>♛❖ 𝑴7𝑺 𝑻𝑬𝑳𝑬 𝑩𝑶𝑻 𝑯𝑶𝑺𝑻𝑰𝑵𝑮❖ ♛ 🦁 𝐁𝐑𝐎𝐀𝐃𝐂𝐀𝐒𝐓</b> 📢    ║
╠══════════════════════════════════════╣
║
{broadcast_text}
║
...
"""
    ...
    result_text = f"""
╔══════════════════════════════════════╗
║     ✅ <b>♛❖ 𝑴7𝑺 𝑻𝑬𝑳𝑬 𝑩𝑶𝑻 𝑯𝑶𝑺𝑻𝑰𝑵𝑮❖ ♛ 𝐁𝐑𝐎𝐀𝐃𝐂𝐀𝐒𝐓 𝐂𝐎𝐌𝐏𝐋𝐄𝐓𝐄</b> ✅ ║
╠══════════════════════════════════════╣
║
║  📤 𝐓𝐨𝐭𝐚𝐥: {total}
║  ✅ 𝐒𝐮𝐜𝐜𝐞𝐬𝐬: {success}
...
def subscribe_command(message):
    ...
    sub_text = f"""
╔══════════════════════════════════════╗
║      ✅ <b>♛❖ 𝑴7𝑺 𝑻𝑬𝑳𝑬 𝑩𝑶𝑻 𝑯𝑶𝑺𝑻𝑰𝑵𝑮❖ ♛ 𝐒𝐔𝐁𝐒𝐂𝐑𝐈𝐏𝐓𝐈𝐎𝐍</b> ✅   ║
╠══════════════════════════════════════╣
║
║  👤 𝐔𝐬𝐞𝐫: {target_user}
║  📅 𝐃𝐚𝐲𝐬: {days}
...
"""
    ...
    try:
        bot.send_message(target_user, f"🎉 𝐘𝐨𝐮'𝐯𝐞 𝐛𝐞𝐞𝐧 𝐬𝐮𝐛𝐬𝐜𝐫𝐢𝐛𝐞𝐝 𝐟𝐨𝐫 {days} 𝐝𝐚𝐲𝐬 𝐛𝐲 𝑴7𝑺 𝑻𝑬𝑳𝑬 𝑩𝑶𝑻!")
    except:
        pass
...
def handle_text(message):
    ...
    if text == "📢 Updates Channel":
        bot.send_message(message.chat.id, f"📢 𝐉𝐨𝐢𝐧 𝐨𝐮𝐫 𝑴7𝑺 𝑻𝑬𝑳𝑬 𝑩𝑶𝑻 𝐮𝐩𝐝𝐚𝐭𝐞𝐬:\n{UPDATE_CHANNEL}")
...
def handle_upload_request(message):
    ...
    upload_text = f"""
╔══════════════════════════════════════╗
║       📤 <b>♛❖ 𝑴7𝑺 𝑻𝑬𝑳𝑬 𝑩𝑶𝑻 𝑯𝑶𝑺𝑻𝑰𝑵𝑮❖ ♛: FILE UPLOAD</b> 📤   ║
╠══════════════════════════════════════╣
║
║  𝐒𝐞𝐧𝐝 𝐲𝐨𝐮𝐫 𝐟𝐢𝐥𝐞 𝐧𝐨𝐰!
║
...
def show_user_files(message):
    ...
    user_id = message.from_user.id
    msg = send_spinner_animation(message.chat.id, "𝐋𝐨𝐚𝐝𝐢𝐧𝐠 𝑴7𝑺 𝑻𝑬𝑳𝑬 𝑩𝑶𝑻 𝐟𝐢𝐥𝐞𝐬...", duration=1)
    files = user_files.get(user_id, [])
    if not files:
        text = """
╔══════════════════════════════════════╗
║       📂 <b>♛❖ 𝑴7𝑺 𝑻𝑬𝑳𝑬 𝑩𝑶𝑻 𝑯𝑶𝑺𝑻𝑰𝑵𝑮❖ ♛: YOUR FILES</b> 📂   ║
╠══════════════════════════════════════╣
║
...
def show_subscriptions(message):
    ...
    text = f"""
╔══════════════════════════════════════╗
║     💳 <b>♛❖ 𝑴7𝑺 𝑻𝑬𝑳𝑬 𝑩𝑶𝑻 𝑯𝑶𝑺𝑻𝑰𝑵𝑮❖ ♛: SUBSCRIPTIONS</b> 💳    ║
╠══════════════════════════════════════╣
║
...
def show_admin_panel(message):
    ...
    admin_text = f"""
╔══════════════════════════════════════╗
║       👑 <b>♛❖ 𝑴7𝑺 𝑻𝑬𝑳𝑬 𝑩𝑶𝑻 𝑯𝑶𝑺𝑻𝑰𝑵𝑮❖ ♛: ADMIN PANEL</b> 👑   ║
╠══════════════════════════════════════╣
║
║  <b>📊 𝐒𝐭𝐚𝐭𝐢𝐬𝐭𝐢𝐜𝐬:</b>
...
def handle_document(message):
    ...
    upload_text = f"""
╔══════════════════════════════════════╗
║      📤 <b>♛❖ 𝑴7𝑺 𝑻𝑬𝑳𝑬 𝑩𝑶𝑻 𝑯𝑶𝑺𝑻𝑰𝑵𝑮❖ ♛: UPLOADING</b> 📤     ║
╠══════════════════════════════════════╣
║
...
def stop_user_script(call, file_name):
    ...
    stop_text = f"""
╔══════════════════════════════════════╗
║       🛑 <b>♛❖ 𝑴7𝑺 𝑻𝑬𝑳𝑬 𝑩𝑶𝑻 𝑯𝑶𝑺𝑻𝑰𝑵𝑮❖ ♛: STOPPING</b> 🛑     ║
╠══════════════════════════════════════╣
║
...
"""
    ...
    if script_info:
        ...
        success_text = f"""
╔══════════════════════════════════════╗
║       ✅ <b>♛❖ 𝑴7𝑺 𝑻𝑬𝑳𝑬 𝑩𝑶𝑻 𝑯𝑶𝑺𝑻𝑰𝑵𝑮❖ ♛: STOPPED</b> ✅      ║
╠══════════════════════════════════════╣
║
║  📄 <code>{file_name[:25]}</code>
...
def delete_user_file(call, file_name):
    ...
    confirm_text = f"""
╔══════════════════════════════════════╗
║      ⚠️ <b>♛❖ 𝑴7𝑺 𝑻𝑬𝑳𝑬 𝑩𝑶𝑻 𝑯𝑶𝑺𝑻𝑰𝑵𝑮❖ ♛: DELETE?</b> ⚠️      ║
╠══════════════════════════════════════╣
║
║  𝐀𝐫𝐞 𝐲𝐨𝐮 𝐬𝐮𝐫𝐞?
║  📄 <code>{file_name[:25]}</code>
...
def confirm_delete_file(call, file_name):
    ...
    delete_text = f"""
╔══════════════════════════════════════╗
║       🗑️ <b>♛❖ 𝑴7𝑺 𝑻𝑬𝑳𝑬 𝑩𝑶𝑻 𝑯𝑶𝑺𝑻𝑰𝑵𝑮❖ ♛: DELETING</b> 🗑️     ║
╠══════════════════════════════════════╣
║
║  📄 <code>{file_name[:25]}</code>
║  ⏳ 𝐏𝐥𝐞𝐚𝐬𝐞 𝐰𝐚𝐢𝐭...
...
"""
    ...
    try:
        if os.path.exists(file_path):
            ...
            success_text = f"""
╔══════════════════════════════════════╗
║       ✅ <b>♛❖ 𝑴7𝑺 𝑻𝑬𝑳𝑬 𝑩𝑶𝑻 𝑯𝑶𝑺𝑻𝑰𝑵𝑮❖ ♛: DELETED</b> ✅       ║
╠══════════════════════════════════════╣
║
║  📄 <code>{file_name[:25]}</code>
...
def stop_all_bots(call):
    ...
    if user_id != OWNER_ID and user_id not in admin_ids:
        ...
        return
    bot.answer_callback_query(call.id, "🛑 𝐒𝐭𝐨𝐩𝐩𝐢𝐧𝐠 𝐚𝐥𝐥 ♛❖ 𝑴7𝑺 𝑻𝑬𝑳𝑬 𝑩𝑶𝑻 𝑯𝑶𝑺𝑻𝑰𝑵𝑮❖ ♛ 𝐛𝐨𝐭𝐬...")
    stopped = 0
...
def show_admin_logs(call):
    ...
    try:
        ...
        conn.close()
        if logs:
            text = "📋 <b>♛❖ 𝑴7𝑺 𝑻𝑬𝑳𝑬 𝑩𝑶𝑻 𝑯𝑶𝑺𝑻𝑰𝑵𝑮❖ ♛: RECENT LOGS</b>\n"
            for log in logs:
                text += f"👤 {log[0]} | {log[1]}\n{log[2][:30]}...\n🕐 {log[3][:16]}\n"
        else:
            text = "📋 𝐍𝐨 𝐥𝐨𝐠𝐬."
...
def cleanup_on_exit():
    ...
    logger.info("𝐂𝐥𝐞𝐚𝐧𝐢𝐧𝐠 𝐮𝐩 𝑴7𝑺 𝑻𝑬𝑳𝑬 𝑩𝑶𝑻...")
    for script_key in list(bot_scripts.keys()):
        try:
            script_info = bot_scripts[script_key]
            kill_process_tree(script_info)
...
def main():
    ...
    logger.info("=" * 50)
    logger.info("🤖 𝐒𝐭𝐚𝐫𝐭𝐢𝐧𝐠 𝑴7𝑺 𝑻𝑬𝑳𝑬 𝑩𝑶𝑻 🦁 𝐁𝐨𝐭...")
    ...
    while True:
        try:
            ...
            logger.error(f"♛❖ 𝑴7𝑺 𝑻𝑬𝑳𝑬 𝑩𝑶𝑻 𝑯𝑶𝑺𝑻𝑰𝑵𝑮❖ ♛ 𝐞𝐫𝐫𝐨𝐫: {e}", exc_info=True)
            time.sleep(5)
